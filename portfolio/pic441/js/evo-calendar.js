...
;(function(factory) {
    ...
    EvoCalendar = (function() {
        ...
        function EvoCalendar(element, settings) {
            ...
            _.initials = {
                ...
                dates: {
                    en: {
                        ...
                        noEventForThisDay: "No events for this day",
            ...
            // CURRENT
            _.$current = {
                month: '10',//(isNaN(this.month) || this.month == null) ? new Date().getMonth() : this.month,
    ...
    EvoCalendar.prototype.init = function(init) {
        ...
        if (!$(_.$elements.calendarEl).hasClass('calendarPhoneApp-initialized')) {
            $(_.$elements.calendarEl).addClass('evo-calendar calendarPhoneApp-initialized');
            ...
            if (_.options.theme) _.setTheme(_.options.theme); // set calendarPhoneApp theme
            _.buildTheBones(); // start building the calendarPhoneApp components
        }
    };
    ...
    EvoCalendar.prototype.destroy = function() {
        ...
        if (_.$elements.calendarEl) {
            _.$elements.calendarEl.removeClass('calendarPhoneApp-initialized');
            _.$elements.calendarEl.removeClass('evo-calendarPhoneApp');
    ...
    // v1.0.0 - Check if date is between the passed calendarPhoneApp date
    ...
    // v1.0.0 - Set calendarPhoneApp theme
    ...
    EvoCalendar.prototype.destroyEventListener = function() {
        ...
        _.$elements.innerEl.find('.calendarPhoneApp-day').children()
            .off('click.evocalendar')
    ...
    EvoCalendar.prototype.buildTheBones = function() {
        ...
        if (!_.$elements.calendarEl.html()) {
            ...
            // sidebar
            markup = '<div class="calendarPhoneApp-sidebar">'+
                '<div class="calendarPhoneApp-year">'+
                ...
                '<ul class="calendarPhoneApp-months">';
            ...
            // inner
            markup += '<div class="calendarPhoneApp-inner">'+
                '<table class="calendarPhoneApp-table">'+
                '<tr><th colspan="7"></th></tr>'+
                '<tr class="calendarPhoneApp-header">';
            for(var i = 0; i < _.$label.days.length; i++ ){
                var headerClass = "calendarPhoneApp-header-day";
            ...
            // events
            markup += '<div class="calendarPhoneApp-events">'+
            ...
            if (!_.$elements.sidebarEl) _.$elements.sidebarEl = $(_.$elements.calendarEl).find('.calendarPhoneApp-sidebar');
            if (!_.$elements.innerEl) _.$elements.innerEl = $(_.$elements.calendarEl).find('.calendarPhoneApp-inner');
            if (!_.$elements.eventEl) _.$elements.eventEl = $(_.$elements.calendarEl).find('.calendarPhoneApp-events');
    ...
    EvoCalendar.prototype.addEventList = function(event_data) {
        ...
        markup += '></div></div><div class="event-info"><p class="event-title">'+event_data.name;//_.limitTitle(event_data.name);
        if (event_data.badge) markup += '<span>'+event_data.badge+'</span>';
        markup += '</p>'
        if (event_data.description) markup += '<p class="event-desc" style="font-size: large; text-align: center">'+event_data.description+'</p> <p class="event-desc" style="font-size: x-large;">'+event_data.eventtime+'</p>';
        markup += '</div>';
        markup += '</div>';
        eventListEl.append(markup);
    ...
    EvoCalendar.prototype.buildSidebarYear = function() {
        ...
        _.$elements.sidebarEl.find('.calendarPhoneApp-year > p').text(_.$active.year);
    }
    ...
    EvoCalendar.prototype.buildSidebarMonths = function() {
        ...
        _.$elements.sidebarEl.find('.calendarPhoneApp-months > [data-month-val]').removeClass('active-month');
        _.$elements.sidebarEl.find('.calendarPhoneApp-months > [data-month-val="'+_.$active.month+'"]').addClass('active-month');
    }
    ...
    EvoCalendar.prototype.buildCalendar = function() {
        ...
        _.$elements.innerEl.find('.calendarPhoneApp-table th').text(title);

        _.$elements.innerEl.find('.calendarPhoneApp-body').remove(); // Clear days

        markup += '<tr class="calendarPhoneApp-body">';
        var day = 1;
        for (var i = 0; i < 9; i++) { // this loop is for is weeks (rows)
            for (var j = 0; j < _.$label.days.length; j++) { // this loop is for weekdays (cells)
                if (day <= _.monthLength && (i > 0 || j >= _.startingDay)) {
                    var dayClass = "calendarPhoneApp-day";
            ...
            if (day > _.monthLength) {
                ...
                markup += '</tr><tr class="calendarPhoneApp-body">'; // add if not
            }
        }
        markup += '</tr>';
        _.$elements.innerEl.find('.calendarPhoneApp-table').append(markup);

        if(_.options.todayHighlight) {
            _.$elements.innerEl.find("[data-date-val='" + _.$current.date + "']").addClass('calendarPhoneApp-today');
        }
        ...
        if (selectedDate) {
            ...
            _.$elements.innerEl.children().removeClass('calendarPhoneApp-active');
            // Add active class to selected date
            selectedDate.addClass('calendarPhoneApp-active');
        }
    ...
    EvoCalendar.prototype.buildEventIndicator = function() {
        ...
        // prevent duplication
        _.$elements.innerEl.find('.calendarPhoneApp-day > day > .event-indicator').empty();
    ...
    EvoCalendar.prototype.selectDate = function(event) {
        ...
        // Remove active class to all
        _.$elements.innerEl.find('[data-date-val]').removeClass('calendarPhoneApp-active');
        // Add active class to selected date
        activeDayEl.addClass('calendarPhoneApp-active');
    ...
    EvoCalendar.prototype.toggleOutside = function(event) {
        ...
        if (_.$UI.hasEvent && isInnerClicked) _.toggleEventList(true);
    }
    ...
    EvoCalendar.prototype.removeCalendarEvent = function(arr) {
        ...
        function deleteEvent(data) {
            ...
            if (index >= 0) {
                ...
                // Remove event from calendarPhoneApp events
